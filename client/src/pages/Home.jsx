...
const Home = () => {
  ...
  return (
    <AnimatePresence>
        ...
        LET'S <br className='xl:block hidden'></br>
        DO IT.
            </h1>
        </motion.div>
        <motion.div {...headContentAnimation} className='flex flex-col gap-5'>
            <p className='max-w-md font-normal text-gray-600 text-base'>
                Create your unique and excclusive shirt with ourt brand-new 3D customization tool.<strong>Unleash your imagination</strong>
            </p>
